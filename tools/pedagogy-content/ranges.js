...
module.exports = {
  lessons: {
    ...
    'R-05': {
      concept:
        'Tras una línea (open, call, check, bet…), no pongas al rival en “una mano”: reduce su rango a una historia creíble de value, medias y aire.',
      theory: [
        {
          title: 'Cada acción elimina manos',
          body:
            'Asignar rango es ir capeando (recortando) combinaciones imposibles. Quien hace open RFI no tiene 72o. Quien hace call a un 3-bet grande rara vez tiene aire puro. Quien check-raisea flop polariza: fuertes y faroles, menos medias sticky.'
        },
        {
          title: 'Escribe la historia en bandas',
          body:
            'Ejercicio de profesor: en el river, lista 2–3 manos tipo de value, 2–3 medias y 2–3 aires que llegan a esa línea. Si solo puedes imaginar la nuts que te gana, estás sesgado. Contrasta con el menú Rangos cuando exista chart del spot.'
        },
        {
          title: 'Trampa del “siempre me tiene”',
          body:
            'El error clásico es poner al villano siempre en la mano que te gana tras un bet grande. Oblígate a nombrar también faroles y manos medias. Sin aire en su rango, nunca puedes hacer call; sin value, nunca puedes fold — y ambos extremos son sospechosos.'
        }
      ],
      examples: [
        {
          ...
          body:
            'BTN open, BB call, flop check-check, turn bet BTN, river bet. El rango del BTN en river ya no es el RFI entero: se densificó en value y algunos faroles; muchas basuras checkearon atrás en turn.'
        },
        {
        ...
        },
        {
          ...
          body:
            'Papel: Value | Medias | Aire. Rellena tras narrar la línea en voz alta. Si una columna está vacía, tu asignación es incompleta.'
        }
      ],
      aiQuestions: [
