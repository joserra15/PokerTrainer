...
// --- BB vs UTG ---
near(ST.vsRfiStrategy('BB_vs_UTG', 'JJ', CASH, 'BB', 'UTG').raise, 1.0, 0.01, 'BB vs UTG JJ 3bet');
near(ST.vsRfiStrategy('BB_vs_UTG', 'AQs', CASH, 'BB', 'UTG').call, 1.0, 0.01, 'BB vs UTG AQs call');
near(ST.vsRfiStrategy('BB_vs_UTG', 'A5s', CASH, 'BB', 'UTG').raise, 0.2, 0.01, 'BB vs UTG A5s 3bet');
{
  const g = globalVsRfi('BB_vs_UTG');
  softNear(g.threeBet, 0.031, 0.02, 'BB vs UTG global 3bet');
  softNear(g.call, 0.104, 0.05, 'BB vs UTG global call');
}
