...
(function (global) {
  ...
  /** 3-bet shove river microlímites: valor polarizado (full houses+, pocos faroles). */
  const RANGE_FACING_RIVER_3BET_SHOVE = 'TT, 22, 33, T2s, T3s, 23s, JJ, QQ, KK, AA';
  ...
  global.GTORangesData = {
    ...
    RANGE_FACING_TURN_RAISE, RANGE_FACING_RIVER_SHOVE, RANGE_FACING_RIVER_3BET_SHOVE,
