...
(function (global) {
  ...
  var DICT = {
    es: {
      ...
      'play.hideActionLineHint': 'no muestra cómo se llegó al board mientras juegas (solo con flop, turn o river)',
    ...
    en: {
      ...
      'play.hideActionLineHint': 'do not show how the board was reached while you play (flop, turn or river only)',
