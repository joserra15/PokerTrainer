...
(function (global) {
  ...
  var DICT = {
    es: {
      ...
      'nav.support': 'Soporte',
      'nav.login': 'Entrar',
      'hero.title': 'Entrena GTO, importa tus sesiones y mejora con ForgeCoach',
      ...
      'hero.bullet2': 'Import PokerStars, Winamax, GGPoker y 888poker',
      'hero.bullet3': 'Plan gratis ahora · FOUNDER el 15 de noviembre',
      ...
      'feat.import.body': 'Sube historiales .txt (PokerStars, Winamax, GGPoker, 888poker · cash/spins/torneos) y revísalos en pestañas por tipo de juego.',
      ...
      'limits.trial': 'Study en la beta: con código o acceso regalado (compras cerradas hasta FOUNDER)',
      'limits.card': 'Sin tarjeta. Las compras y el trial de pago abren con FOUNDER el 15 de noviembre de 2026',
      'plan.free': 'Gratis',
      ...
      'plan.coach.invite': 'Solo por invitación en la beta',
      'plan.cta': 'Empezar gratis',
      'plan.cta.paused': 'Compra el {date}',
      'plan.cta.invite': 'Solo por invitación',
      'plan.cta.founder': 'Solicitar plaza FOUNDER',
      'plan.founder.note': 'FOUNDER · {discount} dto. · {seats}. Prioridad a usuarios registrados que lo soliciten.',
      'tab.home': 'Inicio',
      'tab.play': 'Entrenar',
    ...
    en: {
      ...
      'nav.support': 'Support',
      'nav.login': 'Log in',
      'hero.title': 'Train GTO, import your sessions and improve with ForgeCoach',
      ...
      'hero.bullet2': 'Import PokerStars, Winamax, GGPoker and 888poker',
      'hero.bullet3': 'Free plan now · FOUNDER on 15 November',
      ...
      'feat.import.body': 'Upload .txt histories (PokerStars, Winamax, GGPoker, 888poker · cash/spins/tournaments) and review them in tabs by game type.',
      ...
      'limits.trial': 'Study in beta: with a code or gifted access (purchases closed until FOUNDER)',
      'limits.card': 'No card needed. Paid checkout opens with FOUNDER on 15 November 2026',
      'plan.free': 'Free',
      ...
      'plan.coach.invite': 'Invite-only during beta',
      'plan.cta': 'Start free',
      'plan.cta.paused': 'Buy on {date}',
      'plan.cta.invite': 'Invite only',
      'plan.cta.founder': 'Request FOUNDER seat',
      'plan.founder.note': 'FOUNDER · {discount} off · {seats}. Priority for registered users who request it.',
      'tab.home': 'Home',
      'tab.play': 'Train',
