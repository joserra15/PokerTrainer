...
(function (global) {
  ...
  var DICT = {
    es: {
      ...
      'how.s3.body': 'Si quieres entrenar más manos, revisar tus errores, hacer las lecciones de la Escuela de Póker, analizar manos y sesiones, y preguntar dudas a ForgeCoach… regístrate.',
      ...
      'feat.ai.body': 'Consultas sobre manos y sesiones. Gratis incluye 3 de prueba al mes; Study 40 y Coach 150.',
      ...
      'limits.trial': 'Study/Coach FOUNDER: plazas limitadas (compras cerradas hasta el lanzamiento el 1 de octubre)',
      'limits.card': 'Sin tarjeta. Las compras abren con FOUNDER el 1 de octubre; solicita plaza Study o Coach en Planes',
      'plan.free': 'Gratis',
      ...
      'plan.coach.invite': 'FOUNDER Coach · plazas limitadas',
      ...
      'plan.founder.note': 'FOUNDER · {discount} dto. para siempre · {seats}. Solicita tu plaza en Planes.',
      'price.usual': 'Precio habitual',
      'price.monthly': 'Pagando mensual',
      'price.annual': 'Pagando anual',
      'price.perMonth': '/mes',
      'price.perYear': '/año',
      'price.best': 'Mejor precio',
      'price.annualBilled': '{price} €/año',
      'price.annualAlt': 'o {perMonth} €/mes pagando {yearly} €/año',
      'price.founder.lead': 'Hazte {founder} y lo tendrás por',
      'price.founder.leadOwned': 'Tu precio FOUNDER es',
      'price.forever.title': 'Para siempre',
      'price.forever': 'Si entras como FOUNDER conservas ese precio mientras mantengas la suscripción activa.',
      'tab.home': 'Inicio',
      'tab.play': 'Entrenar',
      'tab.school': 'Escuela de Póker',
      'tab.legendary': 'Manos legendarias',
      ...
      'trn.thinking': 'Pensando…',
      'trn.rivalThinking': 'El rival está pensando…',
      'play.actionLine': 'Línea de acción previa',
      'play.hideActionLine': 'Ocultar línea de acción previa',
      'play.hideActionLineHint': 'no muestra cómo se llegó al board mientras juegas, en cualquier calle y formato',
      ...
      'settings.pushPromptTitle': 'Activa las notificaciones',
      'settings.pushPromptLead': 'Recibe avisos en este dispositivo (mensajes y recordatorios). Puedes cambiarlo cuando quieras en Configuración.',
      'settings.pushPromptAccept': 'Aceptar',
      'settings.pushPromptCancel': 'Cancelar',
    ...
    en: {
      ...
      'limits.trial': 'Study/Coach FOUNDER: limited seats (purchases closed until launch in the coming weeks)',
      'limits.card': 'No card needed. Paid checkout opens with FOUNDER in the coming weeks; request Study or Coach in Plans',
      'plan.free': 'Free',
      ...
      'plan.coach.invite': 'FOUNDER Coach · limited seats',
      'plan.cta': 'Try now',
      ...
      'plan.founder.note': 'FOUNDER · {discount} off forever · {seats}. Request your seat in Plans.',
      'price.usual': 'Regular price',
      'price.monthly': 'Paying monthly',
      'price.annual': 'Paying yearly',
      'price.perMonth': '/mo',
      'price.perYear': '/yr',
      'price.best': 'Best price',
      'price.annualBilled': '{price} €/yr',
      'price.annualAlt': 'or {perMonth} €/mo paying {yearly} €/yr',
      'price.founder.lead': 'Become a {founder} and get it for',
      'price.founder.leadOwned': 'Your FOUNDER price is',
      'price.forever.title': 'Forever',
      'price.forever': 'Join as a FOUNDER and you keep that price forever while your subscription stays active.',
      'tab.home': 'Home',
      'tab.play': 'Train',
      'tab.school': 'Poker School',
      'tab.legendary': 'Legendary hands',
      'tab.learn': 'Basics',
      ...
      'trn.thinking': 'Thinking…',
      'trn.rivalThinking': 'Opponent is thinking…',
      'play.actionLine': 'Previous action line',
      'play.hideActionLine': 'Hide previous action line',
      'play.hideActionLineHint': 'do not show how the board was reached while you play, on any street or format',
      ...
      'settings.pushPromptTitle': 'Enable notifications',
      'settings.pushPromptLead': 'Get alerts on this device (messages and reminders). You can change this anytime in Settings.',
      'settings.pushPromptAccept': 'Accept',
      'settings.pushPromptCancel': 'Cancel',
