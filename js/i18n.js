...
(function (global) {
  ...
  var DICT = {
    es: {
      ...
      'nav.support': 'Soporte',
      'nav.login': 'Entrar',
      'hero.eyebrow': 'En español · sin tarjeta · 5 manos trampa',
      'hero.title': 'Juega 5 manos. Mira si aciertas.',
      'hero.lead': 'Spots diseñados para pillar el instinto recreativo. Google solo si quieres guardar el progreso.',
      'hero.cta': 'Probar ahora — sin registro',
      ...
      'hero.bullet1': '5 manos difíciles, sin cuenta',
      'hero.bullet2': 'Google solo para guardar',
      'hero.bullet3': 'Gratis para siempre, con límites',
      'how.title': 'Cómo funciona',
      'how.s1.title': 'Juegas el spot',
      'how.s1.body': 'Cinco trampas: as débil, broadway basura, open UTG, flot de as alto y overcards.',
      'how.s2.title': 'Te puntúan al momento',
      'how.s2.body': 'Óptima, imprecisa o error, con la acción GTO. Sin menús ni configuración.',
      'how.s3.title': 'Guardas si te duele',
      'how.s3.body': 'Si fallas (y suele pasar), crea cuenta con Google y sigue el entrenador completo.',
    ...
    en: {
      ...
      'nav.support': 'Support',
      'nav.login': 'Log in',
      'hero.eyebrow': 'In Spanish · no card · 5 trap hands',
      'hero.title': 'Play 5 hands. See if you get them right.',
      'hero.lead': 'Spots built to catch recreational instincts. Google only if you want to save progress.',
      'hero.cta': 'Try now — no sign-up',
      'hero.how': 'How it works',
      'hero.plans': 'See plans',
      'hero.install': 'Install app',
      'hero.age': '18+ only. Sign-up asks for confirmation.',
      'hero.bullet1': '5 hard hands, no account',
      'hero.bullet2': 'Google only to save',
      'hero.bullet3': 'Free forever, with limits',
      'how.title': 'How it works',
      'how.s1.title': 'You play the spot',
      'how.s1.body': 'Five traps: weak ace, junk broadway, UTG open, ace-high float and overcards.',
      'how.s2.title': 'Instant grade',
      'how.s2.body': 'Optimal, imprecise or error, with the GTO action. No menus.',
      'how.s3.title': 'Save if it stung',
      'how.s3.body': 'If you miss (and you often will), create a Google account and keep training.',
