...
(function (global) {
  ...
  function renderList() {
    ...
    html += '</div>';
    if (!aiOk) {
      html += '<p class="muted-text ha-ai-gate">Añadir con IA consume 1 consulta ForgeCoach. El plan Gratis incluye 3/mes de prueba; Study 40/mes y Coach 150/mes, o usa un bono. Cuando no te queden consultas, esta opción se bloquea.</p>';
    }
