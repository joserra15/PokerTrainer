...
| [`03-carruseles-edu/`](03-carruseles-edu/) | **20 carruseles** (B1–B21; falta B9) + captions |
...
| [`08-reel-aprende-cero/`](08-reel-aprende-cero/) | **Reel prueba**: cold audience · desde cero · DM = 1 mes gratis |
...
## Regenerar sprint FOUNDER (carruseles + features + launch)
```bash
