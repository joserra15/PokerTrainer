...
**Oferta:** **1 mes gratis** si escriben por **privado** (DM).  
**Duración:** 18–22 s · Ratio 9:16 · +18 · herramienta educativa

UTM (si metes link en bio / stories):
```
https://www.pokerforgeai.com/?utm_source=instagram&utm_medium=reel&utm_campaign=aprende_cero_dm
```
...
## Guión CapCut (voz en off o texto grande)

```
[0–2.5s] COVER hook-01.jpg
Texto on-screen: “Te gusta el póker…”
Voz (opcional): “Te gusta el póker…”
...
### Texto on-screen (copiar/pegar a CapCut)
...
#poker #pokerespañol #pokeronline #aprenderpoker #pokertips #pokertraining #nlholdem #estudiopoker #pokerforgeai
```

### Caption corta (alternativa A/B)
...
## Respuesta automática / plantilla DM

Cuando escriban **APRENDER** (o similar):
...
3) Respóndeme con el email de la cuenta y te activo el mes

Empieza por la Escuela (ruta principiantes) + 5–10 manos al día en el entrenador.
Cualquier duda, aquí mismo.
```

Si ya tienen cuenta:
```
Pásame el email con el que entraste y te activo el mes hoy.
```
...
- [ ] Música biblioteca IG (volumen bajo, ritmo constante)
- [ ] Subtítulos auto CapCut (ES) + texto grande en hook
- [ ] Primer frame = hook-01 (no logo solo)
- [ ] CTA DM visible ≥ 3 s (“APRENDER”)
- [ ] End card 2 s
- [ ] Stories gemelas el mismo día: sticker “¿Quieres el mes gratis?” → Sí / Luego
- [ ] Responder DMs en las primeras 2 h
- [ ] Probar A/B: caption larga vs corta

---

## Variante Stories (mismo día)

1. Frame `cta-05-mes-gratis.jpg`
2. Sticker encuesta: “¿Quieres 1 mes gratis?” → Sí / Luego
3. Sticker pregunta: “Escribe APRENDER”
4. Link sticker (opcional) al UTM de arriba
